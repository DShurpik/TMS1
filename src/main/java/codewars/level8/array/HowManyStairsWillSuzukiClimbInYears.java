...
public class HowManyStairsWillSuzukiClimbInYears {
    public static void main(String[] args) {
        ...
        System.out.println(stairsIn20(stairs)); // 54636040
        System.out.println(stairsIn201(stairs)); // 54636040
        System.out.println(stairsIn202(stairs)); // 54636040
    }

    public static long stairsIn20(int[][] stairs) {
        long oneYearTotal = 0;
        for (int[] weekday : stairs) {
            for (int steps : weekday) {
                oneYearTotal += steps;
            }
        }
    ...
    public static long stairsIn201(int[][] stairs) {
        long oneYearTotal = 0;
        for (int i = 0; i < stairs.length; i++) {
            for (int j = 0; j < stairs[i].length; j++) {
                oneYearTotal += stairs[i][j];
            }
        }
        return oneYearTotal * 20;
    }
